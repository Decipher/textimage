...
/**
 * @file
 * Contains \Drupal\textimage\Component\TextUtility.
 */
...
/**
 * Textimage - Text handling methods.
 */
abstract class TextUtility {
   ...
   */
  const PREG_CLASS_SEPARATOR = '\x{20}\x{a0}\x{1680}\x{180e}\x{2000}-\x{200a}\x{2028}\x{2029}\x{202f}\x{205f}\x{3000}';
   ...
   */
  public static function drupalPregMatch($pattern, $subject, &$matches, $flags = NULL, $offset = 0) {
