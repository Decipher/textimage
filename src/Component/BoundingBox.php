...
/**
 * @file
 * Contains \Drupal\textimage\Component\BoundingBox.
 */

namespace Drupal\textimage\Component;

/**
 * Textimage - Font bounding box algebra class.
 */
class BoundingBox {
  ...
  protected function rotateBoxPoints($angle, $top_left_corner_position) {
    ...
    if (!$top_left_corner_position) {
      $min_x = min(array($this->points[0], $this->points[2], $this->points[4], $this->points[6]));
      $min_y = min(array($this->points[1], $this->points[3], $this->points[5], $this->points[7]));
      $max_x = max(array($this->points[0], $this->points[2], $this->points[4], $this->points[6]));
      $max_y = max(array($this->points[1], $this->points[3], $this->points[5], $this->points[7]));
